...
namespace structures
{
	...
	{
		DSRoutines::rangeCheckExcept(index, size_, "Mimo pola");
	...
	inline LinkedListItem<T>* LinkedList<T>::getItemAtIndex(int index) const
	{
		...
		DSRoutines::rangeCheckExcept(index, size(), "Mimo pola");
		LinkedListItem<T>* tmp = first_;
	...
	{
		position_ = ((const LinkedListIterator&)other).position_;
		return *this;
	}
